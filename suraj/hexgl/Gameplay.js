...
suraj.hexgl.Gameplay = function(opts)
{
	var self = this;
...
suraj.hexgl.Gameplay.prototype.simu = function()
{
...
suraj.hexgl.Gameplay.prototype.start = function(opts)
{
	this.finishTime = null;
	this.score = null;
	this.lap = 1;
	...
	this.raceData = new suraj.hexgl.RaceData(this.track.name, this.mode, this.shipControls);
	if(this.mode == 'replay')
	{
...
suraj.hexgl.Gameplay.prototype.end = function(result)
{
...
suraj.hexgl.Gameplay.prototype.update = function()
{
...
suraj.hexgl.Gameplay.prototype.checkPoint = function()
{
