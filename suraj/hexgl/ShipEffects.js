...
suraj.hexgl.ShipEffects = function(opts)
{
	...
	if(this.useParticles)
	{
		...
		this.particles = {
			...
			leftSparks: new suraj.threejs.Particles(
			{
			...
			leftClouds: new suraj.threejs.Particles(
			{
				opacity: 0.8,
				tint: 0xffffff,
				color: 0x666666,
			...
			rightSparks: new suraj.threejs.Particles(
			{
				randomness: new THREE.Vector3(0.4,0.4,0.4),
				tint: 0xffffff,
				color: 0xffc000,
			...
			rightClouds: new suraj.threejs.Particles(
			{
				opacity: 0.8,
				tint: 0xffffff,
				color: 0x666666,
...
suraj.hexgl.ShipEffects.prototype.update = function(dt)
{
