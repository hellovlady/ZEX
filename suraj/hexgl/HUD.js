...
suraj.hexgl.HUD.prototype.resize = function(w, h)
{
	this.width = w;
	this.height = h;
	this.canvas.width = w;
...
suraj.hexgl.HUD.prototype.display = function(msg, duration)
{
	this.messageTiming = 0;
...
suraj.hexgl.HUD.prototype.updateLap = function(current, total)
{
	this.lap = current + this.lapSeparator + total;
}

suraj.hexgl.HUD.prototype.resetLap = function()
{
	this.lap = "";
}

suraj.hexgl.HUD.prototype.updateTime = function(time)
{
	this.time = this.timeSeparators[0] + time.m + this.timeSeparators[1] + time.s + this.timeSeparators[2] + time.ms + this.timeSeparators[3];
}

suraj.hexgl.HUD.prototype.resetTime = function()
{
	this.time = "";
}

suraj.hexgl.HUD.prototype.update = function(speed, speedRatio, shield, shieldRatio)
{
