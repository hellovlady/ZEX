...
suraj.hexgl.RaceData = function(track, mode, shipControls)
{
	this.track = track;
	this.mode = mode;
...
suraj.hexgl.RaceData.prototype.tick = function(time)
{
	if(this.rateState == 1)
	{
...
suraj.hexgl.RaceData.prototype.applyInterpolated = function(time)
{
...
suraj.hexgl.RaceData.prototype.reset = function()
{
	this.seek = 0;
}

suraj.hexgl.RaceData.prototype.export = function()
{
	return this.data;
}

suraj.hexgl.RaceData.prototype.import = function(imp)
{
	this.data = imp;
