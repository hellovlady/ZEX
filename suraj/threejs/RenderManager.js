/*!
 * suraj.threejs.RenderManager helps handling multiple scenes, cameras and render loops.
 * 
 * @author SURAJ SR ABUBAKAR'
 * @license MIT
 * 
 * Initialize the a RenderManager by passing a Renderer object:
 * 		var renderManager = new suraj.threejs.RenderManager(new THREE.WebGLRenderer());
 * 
...
suraj.threejs.RenderManager = function(renderer)
{
...
suraj.threejs.RenderManager.prototype.add = function(id, scene, camera, render, objects)
{
...
suraj.threejs.RenderManager.prototype.get = function(id)
{
	return this.renders[id];
};

suraj.threejs.RenderManager.prototype.remove = function(id)
{
...
suraj.threejs.RenderManager.prototype.renderCurrent = function()
{
...
suraj.threejs.RenderManager.prototype.setCurrent = function(id)
{
	if(id in this.renders)
	{
