 ...
 */
suraj.threejs.Particles = function(opts)
{
...
suraj.threejs.Particles.prototype.build = function()
{
	...
	{
		var p = new suraj.threejs.Particle();
		this.pool.push(p);
		this.buffer.push(p);
 ...
 * @param  int count
 */
suraj.threejs.Particles.prototype.emit = function(count)
{
...
suraj.threejs.Particles.prototype.randomVector = function()
{
 ...
 */
suraj.threejs.Particles.prototype.update = function(dt)
{
	var p, l;
...
suraj.threejs.Particle = function()
{
...
suraj.threejs.Particle.prototype.reset = function()
{
