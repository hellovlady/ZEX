...
/*!
 * @package suraj.threejs
 */
var suraj = suraj || {};
suraj.threejs = suraj.threejs || {};

suraj.NONE = undefined;

/**
 * Creates a new loader
 * @param {Object{onLoad, onError, onProgress}} opts Callbacks
 */
suraj.threejs.Loader = function(opts)
{
	var self = this;
 ...
 */
suraj.threejs.Loader.prototype.load = function(data)
{
	var self = this;
...
suraj.threejs.Loader.prototype.updateState = function(type, name, state)
{
 ...
 * @return Mixed
 */
suraj.threejs.Loader.prototype.get = function(type, name)
{
	if(!(type in this.types))
	{
		console.warn("Unkown loader type.");
...
suraj.threejs.Loader.prototype.loaded = function(type, name)
{
	if(!(type in this.types))
	{
		console.warn("Unkown loader type.");
...
suraj.threejs.Loader.prototype.loadTexture = function(name, url)
{
	var self = this;
...
suraj.threejs.Loader.prototype.loadTextureCube = function(name, url)
{
	var self = this;
...
suraj.threejs.Loader.prototype.loadGeometry = function(name, url)
{
	var self = this;
...
suraj.threejs.Loader.prototype.loadAnalyser = function(name, url)
{
	var self = this;
	this.updateState("analysers", name, false);
	this.data.analysers[name] = new suraj.ImageData(
		url, 
		function(){ 
...
suraj.threejs.Loader.prototype.loadImage = function(name, url)
{
	var self = this;
...
suraj.threejs.Loader.prototype.loadSound = function(src, name, loop){
    var self = this;
    this.updateState("sounds", name, false);
    
    suraj.Audio.addSound(
    	src,
    	name, 
    	loop, 
    	function(){
    ...
    this.data.sounds[name] = {
        play: function(){
            suraj.Audio.play(name);
        },
        stop: function(){
            suraj.Audio.stop(name);
        },
        volume: function(vol){
            suraj.Audio.volume(name, vol);
        }
    };
};