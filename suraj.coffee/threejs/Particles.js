...
(function() {
  ...
  /*
    ...
    @class suraj.threejs.Particle
    @author Thibaut 'suraj' Despoulain <http://suraj.com>
  */
  ...
  */
  ...
  (_base = exports.suraj).threejs || (_base.threejs = {});

  exports.suraj.threejs.Particle = Particle;

  exports.suraj.threejs.Particles = Particles;
